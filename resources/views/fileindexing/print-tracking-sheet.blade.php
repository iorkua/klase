...
<body class="bg-gray-50 p-2 font-sans">
    <div class="print-container max-w-7xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="border-b-2 border-gray-200 p-4">
            ...
            <div class="flex items-center justify-start">
                <div class="text-right text-xs text-gray-600">
                    ...
                    <p><span class="font-semibold">Generated By:</span> {{ $tracker->sheet_generated_at->format('n/j/Y, g:i:s A') }}</p>
        ...
        <div class="p-4 pt-0">
            ...
            <div class="flex items-center justify-between border-t border-gray-400 mt-6 pt-4">
  <!-- Signature -->
  <div class="flex-1 mr-6">
    <span class="block text-sm text-gray-600">Authorized Signature</span>
    <div class="border-b border-gray-600 w-full mt-2"></div>
  </div>

  <!-- Date -->
  <div class="w-40">
    <span class="block text-sm text-gray-600">Date</span>
    <div class="border-b border-gray-600 w-full mt-2"></div>
  </div>
</div>
        </div>
