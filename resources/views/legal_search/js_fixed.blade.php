...
<script>
          ...
          <div class="flex justify-between items-start mb-3">
            <div>
              ...
              <div class="text-sm text-gray-500 mt-1">
                ST: ${extractFileNumbers(file).st} | Parent: ${extractFileNumbers(file).parent} | KANGIS: ${extractFileNumbers(file).kangis} | New KANGIS: ${extractFileNumbers(file).new_kangis}
              </div>
            </div>
          </div>
        </div>
  ...
  const renderLegalSearchReport = () => {
    ...
    document.getElementById('report-file-numbers').textContent = `NewKANGISFileNo: ${selectedFile.NewKANGISFileno || selectedFile.NewKANGISFileNo || 'N/A'}  |  kangisFileNo: ${selectedFile.kangisFileNo || selectedFile.KAGISFileNO || 'N/A'}  |  mlsfNo: ${selectedFile.mlsFNo || selectedFile.MLSFileNo || selectedFile.fileNo || selectedFile.fileno || 'N/A'}`;
    ...
    if (qrCodeImg) {
      const fileInfo = `File Number: MLSF: ${selectedFile.mlsFNo || selectedFile.MLSFileNo || selectedFile.fileNo || 'N/A'} | KANGIS: ${selectedFile.kangisFileNo || selectedFile.KAGISFileNO || 'N/A'} | New KANGIS: ${selectedFile.NewKANGISFileno || selectedFile.NewKANGISFileNo || 'N/A'}`;
