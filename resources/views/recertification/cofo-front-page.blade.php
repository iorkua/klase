...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* Hide label when photo is present */
      .passport-slot.has-photo::after {
        display: none;
      }
      ...
      <div class="main-content">
        ...
        <div class="terms">
          ...
          <ol>
            ...
            <li>
              To pay forthwith to the Kano State Ministry of Land and Physical Planning 
              for Land or such other body or agency appointed by the Governor (if
              not sooner paid) all survey fees and other charges due in respect
              of the preparation, registration and issuance of this certificate.
            </li>
            <li>
            ...
            <li>
              ...
              laid down from time to time by Kano State Government.
            </li>
            <li>
        ...
        <div class="date-section">
          DATED This ___________________________________ day of
          _________________________________,
          20_______________________________<br />

         <em>Given under my hand the day and year </em><br />
          <em> above written</em>
        </div>
        ...
        <div class="signature-section">
          ...
          <div class="signature-name">Alh. Abba Kabir Yusuf</div>
          <div class="signature-title">His Excellency Executive Governor</div>
