            ...
            <div class="space-y-3">
              <div class="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input id="houseNo" name="house_no" type="text" class="form-input text-sm">
                </div>
                <div>
              ...
              <div class="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input id="streetName" name="streetName" type="text" class="form-input text-sm">
                </div>
                <div>
                  <label for="district" class="text-xs text-gray-600">District/Neighbourhood</label>
                  <input id="district" name="district" type="text" class="form-input text-sm">
                </div>
              </div>
              <div class="grid grid-cols-2 gap-3">
                <div>
                  <label for="lga" class="text-xs text-gray-600">LGA</label>
                  <select id="lga" name="lgsaOrCity" class="form-input text-sm">
                ...
                <div>
                  ...
                  <input id="state" name="state" type="text" class="form-input text-sm" placeholder="Enter state" value="Kano">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="space-y-3">
              <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1">
                  ...
                  <select id="transactionType-record" class="form-select text-sm">
              ...
              @include('propertycard.partials.ai.registration_fields')
