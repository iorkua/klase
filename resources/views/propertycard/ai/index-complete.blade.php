    ...
    <div class="p-6">
        <div class="container mx-auto py-6 space-y-6">
            ...
            <div id="ai-assistant-page">
                <!-- AI Property Record Assistant - Complete with All Original Sections -->
                  ...
                  <div id="extracted-details" class="hidden bg-white rounded-lg shadow border-l-4 border-l-green-500">
                    ...
                    <div class="p-6 space-y-6">
                      ...
                      <div class="flex justify-end pt-4 border-t">
                        <button id="save-record-btn" type="button" class="inline-flex items-center justify-center rounded-md font-medium text-sm px-4 py-2 transition-all cursor-pointer border-0 bg-green-600 text-white hover:bg-green-700 gap-2">
                ...
                <script>
                // AI Assistant JavaScript - Complete with All Original Functionality
                (function() {
                  'use strict';
                  ...
                  function setupEventListeners() {
                    ...
                    if (toggleRawTextBtn) {
                      toggleRawTextBtn.addEventListener('click', function(e) {
                        e.preventDefault();
                        toggleRawText();
                      });
                    }
                    ...
                    if (pdfPrevBtn) {
                      pdfPrevBtn.addEventListener('click', function(e) {
                        e.preventDefault();
                        handlePrevPdfPage();
                      });
                    }
                    ...
                    if (pdfNextBtn) {
                      pdfNextBtn.addEventListener('click', function(e) {
                        e.preventDefault();
                        handleNextPdfPage();
                      });
                    }
                  ...
                  async function startAiPropertyProcessing() {
                    ...
                    console.log('AI Assistant: Starting AI processing for:', selectedFile.name);
                  ...
                  // Simplified mock extraction functions for demo
                  async function extractTextFromPropertyDocumentPDF(file) {
                    // Simulate processing time
                    await new Promise(res => setTimeout(res, 1000));
                    aiProgress = Math.min(55, aiProgress + 40);
                    updateAiProcessingUI();
                    return `Mock extracted text from PDF: ${file.name}. This would contain property details like file numbers, parties, registration details, etc.`;
                  }
                  ...
                  async function extractTextFromPropertyDocumentImage(file) {
                    ...
                    aiProgress = Math.min(55, aiProgress + 40);
                    updateAiProcessingUI();
                    return `Mock extracted text from image: ${file.name}. This would contain property details like file numbers, parties, registration details, etc.`;
                  }

                  function extractPropertyInstrumentDetails(text, fileName) {
                    // Mock extraction - in real implementation this would parse the text
                    return {
                      ...
                      vol: '001',
                      regNo: '001/001/001',
                      extractionStatus: 'High Confidence'
                    };
                  }
                  ...
                  function showExtractionResults() {
                    ...
                    if (instrumentsFound.length > 0) {
                      ...
                      if (keywordCard && description && list) {
                  ...
                  function populatePropertyForm() {
                    ...
                    const confidenceElement = document.getElementById('extraction-confidence');
                    ...
                    const fields = {
                      'kangisFileNo': data.kangisFileNo,
                      'plotNo': data.plotNo,
                      'lga': data.lgsaOrCity,
                  ...
                  function renderInstruments() {
                    ...
                    if (!container || !noInstruments) return;
                    ...
                    // Simple instrument display for demo
                      ...
                      <div class="bg-white rounded-lg border instrument-card">
                        <div class="p-4">
                          ...
                          <div class="text-sm text-gray-600 space-y-1">
                            ${instrument.parties?.assignor ? `<p><span class="font-medium">Assignor:</span> ${instrument.parties.assignor}</p>` : ''}
                            ${instrument.parties?.assignee ? `<p><span class="font-medium">Assignee:</span> ${instrument.parties.assignee}</p>` : ''}
                            ${instrument.registrationDetails?.regNo ? `<p><span class="font-medium">Reg No:</span> ${instrument.registrationDetails.regNo}</p>` : ''}
                          </div>
                        </div>
                      </div>
                    `).join('');
                  ...
                  function handleSaveRecord() {
                    ...
                    if (primaryInstrument) {
                      ...
                      formData.append('pageNo', primaryInstrument.registrationDetails?.page || '');
