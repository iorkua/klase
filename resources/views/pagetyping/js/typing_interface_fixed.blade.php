...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!documentViewer) {
        ...
        showError('Document viewer not found. Please refresh the page.');
        return;
    }
    
    if (!selectedFileIndexing) {
        console.error('No selected file indexing');
        showError('No file selected for typing. Please go back and select a file.');
        return;
    }
    ...
    // Add the missing startPageTyping function
