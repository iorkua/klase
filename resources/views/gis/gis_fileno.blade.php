...
<script>
    ...
    function updateMlsFileNumberPreview() {
        ...
        if (prefix && number) {
            ...
            filenoEl.value = formatted; // Set the main fileno field
        } else if (prefix) {
            previewEl.value = prefix;
            dbFieldEl.value = prefix;
            filenoEl.value = prefix;
        } else if (number) {
            previewEl.value = number;
            dbFieldEl.value = number;
            filenoEl.value = number;
        } else {
            previewEl.value = '';
            dbFieldEl.value = '';
            filenoEl.value = '';
    ...
    function updateFormFileData() {
        ...
        // Set the main fileno field based on the active tab
        if (activeTab === "mlsFNo") {
            filenoEl.value = document.getElementById('mlsPreviewFileNumber').value;
        } else if (activeTab === "kangisFileNo") {
            filenoEl.value = document.getElementById('kangisPreviewFileNumber').value;
        } else if (activeTab === "NewKANGISFileno") {
            filenoEl.value = document.getElementById('newKangisPreviewFileNumber').value;
        }
