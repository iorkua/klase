                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                ...
                                <div>
                                    ...
                                    <select id="applicantTitle" name="applicant_title" required
                                        ...
                                        <option value="HRH" {{ old('applicant_title') == 'HRH' ? 'selected' : '' }}>HRH</option>
                                        <option value="Mallam" {{ old('applicant_title') == 'Mallam' ? 'selected' : '' }}>Mallam</option>
                                        ...
                                        <option value="Hajia" {{ old('applicant_title') == 'Hajia' ? 'selected' : '' }}>Hajia</option>
