               ...
               <div class="bg-blue-50 border border-blue-100 rounded-md p-4 mb-6">
                   <div class="flex items-start">
                       ...
                       <div>
                           ...
                           <p class="text-sm text-blue-600">Please upload all required documents. Acceptable formats are
                               PDF, JPG, and PNG. Maximum file size is 5MB per document.</p>
                       </div>
                   </div>
               </div>
               ...
               <div class="grid grid-cols-2 gap-6 mb-6">
                   <div class="border border-gray-200 rounded-md p-4">
                       ...
                       <div class="border-2 border-dashed border-gray-300 rounded-md p-6 text-center">
                           ...
                           <p class="text-xs text-gray-500 mt-2" id="application_letter_name">PDF, JPG or PNG (max. 5MB)
                           </p>
                       </div>
                   </div>
               ...
               <div class="grid grid-cols-2 gap-6 mb-6">
                   <div class="border border-gray-200 rounded-md p-4">
                       ...
                       <div class="border-2 border-dashed border-gray-300 rounded-md p-6 text-center">
                           ...
                           <p class="text-xs text-gray-500 mt-2" id="architectural_design_name">PDF, JPG or PNG (max.
                               5MB)</p>
                       </div>
                   </div>
                   ...
                   <div class="border border-gray-200 rounded-md p-4">
                       ...
                       <div class="border-2 border-dashed border-gray-300 rounded-md p-6 text-center">
                           ...
                           <p class="text-xs text-gray-500 mt-2" id="ownership_document_name">PDF, JPG or PNG (max.
                               5MB)</p>
                       </div>
                   </div>
               </div>
