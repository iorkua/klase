            ...
            <div class="p-6">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <span class="summary-value">
                                <span class="file-number-badge">{{ $parentApplication->fileno ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                            ...
                            <span class="summary-value">
                                <span class="land-use-badge">{{ $parentApplication->land_use ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                            ...
                            <span class="summary-value">
                                <span class="location-badge">{{ $parentApplication->property_street_name ?? 'N/A' }}, {{ $parentApplication->property_lga ?? 'N/A' }}</span>
                            </span>
                        </div>
                        {{-- <div class="summary-item">
                ...
                <div class="application-summary">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">
                        <i data-lucide="building" class="w-5 h-5 mr-2 inline"></i>
                        Unit Application Summary
                    </h3>
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <span class="summary-value">
                                <span class="file-number-badge">{{ $subApplication->fileno ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="home" class="summary-icon"></i>
                                Unit Number
                            </span>
                            <span class="summary-value">
                                <span class="unit-badge">Unit {{ $subApplication->unit_number ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="building-2" class="summary-icon"></i>
                                Block Number
                            </span>
                            <span class="summary-value">
                                <span class="unit-badge">Block {{ $subApplication->block_number ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="layers" class="summary-icon"></i>
                                Floor Number
                            </span>
                            <span class="summary-value">
                                <span class="unit-badge">Floor {{ $subApplication->floor_number ?? 'N/A' }}</span>
                            </span>
                        </div>
                        {{-- <div class="summary-item">
                            <span class="summary-label">
                            ...
                            <span class="summary-value">
                                @php
                                    $status = strtolower($subApplication->application_status ?? 'pending');
                                ...
                                <span class="status-badge {{ $statusClass }}">
                                    ...
                                    {{ $subApplication->application_status ?? 'Pending' }}
                                </span>
                            </span>
                        </div> --}}
                        @if($fileIndexing)
