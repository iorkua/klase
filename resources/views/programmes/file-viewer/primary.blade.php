...
<style>
    ...
    /* Enhanced Application Summary Styles */
    .application-summary {
        ...
        <div class="content-card">
            ...
            <div class="header-section">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold mb-2">File Viewer - Primary Application</h1>
                        <p class="text-blue-100">{{ $ownerName }}</p>
                        <p class="text-blue-200 text-sm">File No: {{ $application->fileno ?? 'N/A' }}</p>
                    </div>
                    <div class="text-right">
                        <a href="{{ route('programmes.eRegistry') }}" class="bg-white text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-50 transition-colors">
            ...
            <div class="p-6">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="hash" class="summary-icon"></i>
                                File Number
                            </span>
                            <span class="summary-value">
                                <span class="file-number-badge">{{ $application->fileno ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="file-check" class="summary-icon"></i>
                                ST File Number
                            </span>
                            <span class="summary-value">
                                <span class="file-number-badge">{{ $application->np_fileno ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="map" class="summary-icon"></i>
                                Land Use
                            </span>
                            <span class="summary-value">
                                <span class="land-use-badge">{{ $application->land_use ?? 'N/A' }}</span>
                            </span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="map-pin" class="summary-icon"></i>
                                Property Location
                            </span>
                            <span class="summary-value">
                                <span class="location-badge">{{ $application->property_street_name ?? 'N/A' }}, {{ $application->property_lga ?? 'N/A' }}</span>
                            </span>
                        </div>
                        {{-- <div class="summary-item">
                              <span class="summary-label">
                            ...
                            <span class="summary-value">
                                @php
                                    $status = strtolower($application->application_status ?? 'pending');
                        ...
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="folder" class="summary-icon"></i>
                                File Title
                            </span>
                        ...
                        <div class="summary-item">
                            <span class="summary-label">
                                <i data-lucide="grid-3x3" class="summary-icon"></i>
                                Plot Number
                            </span>
                ...
                @else
                    <div class="no-files-message">
                        ...
                        <p class="text-gray-500">This application has not been processed through the EDMS system yet, or no files have been uploaded.</p>
                    </div>
                @endif
            </div>
        </div>
