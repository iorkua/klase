<div 
    ...
    <a href="#"
   @if($app->status == 'pending' && $app->instrument_type === 'ST Fragmentation') 
   ...
   @endif
>
    <i class="fas fa-file-signature mr-2 {{ $app->status == 'pending' && $app->instrument_type === 'ST Fragmentation' ? 'text-green-500' : 'text-gray-300' }}"></i>
    Register Instrument
</a>
