...
<div class="flex-1 overflow-auto">
    ...
    @include('instrument_registration.partials.batchregistermodal_final')
...
<!-- Include the FIXED batch registration handler for pre-selected instruments -->
<script src="{{ asset('js/batch_registration_handler_fixed.js') }}?v={{ time() }}"></script>
...
// Enhanced batch registration functionality - FIXED VERSION
