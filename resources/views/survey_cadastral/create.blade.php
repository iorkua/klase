...
<div class="flex-1 overflow-auto">
    ...
    <!-- Update Survey Form -->
    <div class="p-6">
        <form id="update-survey-form" method="POST" action="{{ route('survey_cadastral.store') }}" enctype="multipart/form-data">
            @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $(filenoSelect).on('select2:select', function(e) {
        ...
        if (selectedApplication) {
            // Use the handleDropdownSelection function from smart fileno selector to set the main fileno field
